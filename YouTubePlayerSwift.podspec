...
Pod::Spec.new do |s|
  ...
  s.version          = '0.2.0'
  s.summary          = 'Easy to use library to play YouTubeVideos in fullscreen mode (Swift 5.0).'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
Easy to use library to play YouTubeVideos in fullscreen mode (Swift 5.0). "YouTube" and the "YouTube logo" are registered trademarks of Google Inc.
                       DESC
