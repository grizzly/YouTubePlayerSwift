...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YouTubePlayerSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/st.mayr@grizzly.cc/YouTubePlayerSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'st.mayr@grizzly.cc' => 'st.mayr@grizzly.cc' }
  s.source           = { :git => 'https://github.com/st.mayr@grizzly.cc/YouTubePlayerSwift.git', :tag => s.version.to_s }
